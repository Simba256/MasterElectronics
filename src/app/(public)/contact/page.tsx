...
export default async function ContactPage() {
  ...
  const social = settingsMap.social || {}
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-xl text-gray-300 max-w-2xl mx-auto">
            Get in touch with our team for inquiries, support, or to learn more about our products
          </p>
        </div>
      </section>
                ...
                <div className="flex space-x-4">
                  {social.facebook && (
                    <a
                      ...
                      className="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white hover:bg-primary-700 transition-colors"
                    >
