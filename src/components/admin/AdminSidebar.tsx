...
const navigation = [
  ...
  { name: 'Testimonials', href: '/admin/testimonials', icon: TestimonialIcon },
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-gray-900">
      ...
      <div className="border-t border-gray-800 p-4">
        ...
        <Link
          href="/"
          className="mt-2 flex w-full items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white transition-colors"
        >
          <svg className="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
